...
var createNewTaskElement=function(taskString){
    ...
    listItem.className = "tasks__list-item list__item";
    ...
    editInput.type="text";
    editInput.className="tasks__task tasks__input-text tasks__input-text_edit";
    ...
    deleteButtonImg.classList = "btn__delete-img";
...
var editTask=function(){
    ...
    editInput.classList.toggle("tasks__input-text_edit");
    label.classList.toggle("tasks__task-label_edit");
};
